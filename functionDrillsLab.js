...
// function theEliminator(contestantsList, loserList){
//   for (let i = 0; i < contestantsList.length; i++){
//     if (contestantsList[i] === loserList){
//       contestantsList.splice([i], 1)
//     }
//   }
...
//   let frogCost = 3;
//   let totalFrogs = Math.floor(gold / frogCost);
...
//   let frogCost = 3;
//   let totalFrogs2 = Math.floor(gold / frogCost);
